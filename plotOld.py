...
def Delta_vs_Q(filename, data_plt_bl, data_plt_zero, data_plt_one, data_plt_two, data_plt_three, n):
    ...
    labels = ['p=0', 'p=0.1', 'p=0.5', 'p=1']
    
    f = plt.figure(figsize=(10,10))
       
    plt.plot(data_plt_zero[:,2]*comb(n, 2), data_plt_zero[:,0]*comb(n, 2), '-.', color='magenta', linewidth=4, label=labels[0])
    #plt.fill_between(data_plt_zero[:,2], data_plt_zero[:,0]-data_plt_zero[:,1]/2, data_plt_zero[:,0]+data_plt_zero[:,1]/2, 
    ...
    #plt.fill_between(data_plt_one[:,2], data_plt_one[:,0]-data_plt_one[:,1]/2, data_plt_one[:,0]+data_plt_one[:,1]/2, 
    ...
    #plt.fill_between(data_plt_two[:,2], data_plt_two[:,0]-data_plt_two[:,1]/2, data_plt_two[:,0]+data_plt_two[:,1]/2, 
    ...
    #plt.fill_between(data_plt_three[:,2], data_plt_three[:,0]-data_plt_three[:,1]/2, data_plt_three[:,0]+data_plt_three[:,1]/2, 
    ...
    f.savefig(filename + "new_old_ACCvsKC_scalex2.pdf", bbox_inches='tight')
